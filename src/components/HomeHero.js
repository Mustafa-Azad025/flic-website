  ...
  return (
    <>
      <div className="grid sm:h-auto overflow-x-hidden bg-[#202020]">
        <div className="mx-auto sm:mx-32 flex flex-col pt-16 md:pt-32">
          <motion.h1 initial={{opacity:0,y:100}} animate={{opacity:1,y:0}} transition={{delay:0.5,duration:1.5,bounce:2}} className="font-['Epilogue'] antialiased text-white md:text-4xl text-3xl font-[500] md:w-96 w-56 mx-4 sm:mx-0 sm:leading-[5rem] leading-[4rem] tracking-wide">
          ...
          <motion.p initial={{opacity:0,y:100}} animate={{opacity:1,y:0}} transition={{delay:0.9,duration:1.5,bounce:2}} className="font-['Epilogue'] font-[200] antialiased mx-4 md:mx-0 w-60 md:w-auto text-[#949494] my-4 pb-4">
        ...
        <div className="sm:pl-12 pl-0 grid grid-cols-1 sm:flex w-full space-y-8 mt-2 sm:space-y-0 sm:pt-20">
          <div className="sm:mx-16">
            ...
            <motion.p initial={{opacity:0,y:100}} animate={{opacity:1,y:0}} transition={{delay:1.2,duration:1.1,bounce:2}} className="sm:w-60 w-48 ml-[4.2rem] text-sm text-[#828282]">
